...
class ComputadoraDificil(Jugador):
    ...
    def posibilidades(self,tablero):
        ...
        for llaves in LISTA_COORDENADAS:
            self.posibilidadesRangos(tablero,posibles_coordenadas,LISTA_COORDENADAS[llaves])
    ...
    def segundo_ataque(self,tablero):
        ...
        coor = None
        if self.chequearRangoTapado(tablero,LISTA_COORDENADAS['columnas'][0]) == False and self.hayFichasPropiasRangos(tablero,[LISTA_COORDENADAS['columnas'][0],LISTA_COORDENADAS['diagonales'][1]]) == True:
    ...
    def modo_ataque(self,tablero):  
        ...
        if coor != None:
            ...
            # En caso Nonepositivo realiza el movimento
            return coor
        # Y como ultima opcion devuelve el primer lugar vacio que encuentre
